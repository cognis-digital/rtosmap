#!/usr/bin/env sh
# Universal installer for rtosmap. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/rtosmap.git"
echo "Installing rtosmap ..."
